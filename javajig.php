...
<!-- javajig.html  08 Mar 2016 20:02:28 GMT -->
<head>
	...
	<title>Java Jig - InfoXpression 2015</title>
						...
						<article class="entry wow fadeInDown" data-wow-duration="1000ms" data-wow-delay="300ms">
							<div class="post-thumb">
								<a href="single-post.html">
									<img src="img/event/javajig.jpg" class="img-responsive">
								</a>
							</div>
							<br>
							<div class="post-excerpt">
								...
								<p><em>ROUND 1</em> &ndash; <strong>Basic testing</strong>
								</p>
								<ul style="margin: 0 0 0 20px; list-style: square">
									<li>It will be an individual round.</li>
									<li>There will be set of question (MCQs).</li>
									<li>Each question will carry 1 point.</li>
									<li>There will be penalty for wrong selection i.e., &frac14;.</li>
									<li>Time limit will be 30 mins.</li>
									<li>No use of unfair means (mobiles, internet,etc.). If found participant will be disqualified.</li>
								</ul>
								<p>&nbsp;</p>
								<p><em>ROUND 2</em> &ndash; <strong>Code It!</strong>
								</p>
								<ul style="margin: 0 0 0 20px; list-style: square">
									<li>You will have to write a code for the given problem.</li>
									<li>Problem will be given on the spot.</li>
									<li>You will be using either &ldquo;netbeans&rdquo; or &ldquo;code blocks&rdquo;.</li>
									<li>Time limit will be 45 mins.</li>
									<li>Participants who coded the program in an efficient way with less complexity will be get more marks.</li>
									<li>No use of unfair means.</li>
								</ul>
							</div>
							<br>
						</article>
						<div class="next-prev clearfix">
							<a href="greenovation.html" class="prev-post">
								<i class="fa fa-angle-left fa-2x"></i>Previous Event
							</a>
							<a href="knowitall.html" class="next-post pull-right">
...
<!-- javajig.html  08 Mar 2016 20:02:31 GMT -->
</html>
